...
function useFullscreen(options) {
    ...
    var _b = __read(react_1.useState(Boolean(document[fullscreenControls.fullscreenElement])), 2), isFullscreen = _b[0], setIsFullscreen = _b[1];
    var _c = __read(react_1.useState(document[fullscreenControls.fullscreenElement]), 2), element = _c[0], setElement = _c[1];
