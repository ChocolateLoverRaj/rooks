...
describe("useThrottle hook", function () {
    ...
    beforeEach(function () {
        App = function () {
            var _a = __read(react_2.useState(0), 2), number = _a[0], setNumber = _a[1];
            var _b = __read(react_2.useState(0), 2), argumentNumber = _b[0], setArgumentNumber = _b[1];
            var addNumber = function () { return setNumber(number + 1); };
            var _c = __read(useThrottle_1.useThrottle(addNumber, TIMEOUT), 1), addNumberThrottled = _c[0];
            var addNumberWithParameter = function (argumentNumber_) {
                setArgumentNumber(argumentNumber_ + 2);
                setNumber(number + 1);
            };
            var _d = __read(useThrottle_1.useThrottle(function () { return addNumberWithParameter(5); }, 1000), 1), addNumberThrottledWithParameter = _d[0];
            return (react_2.default.createElement("div", null,
                react_2.default.createElement("span", { "data-testid": "throttle-value" }, number),
                react_2.default.createElement("span", { "data-testid": "throttle-value-with-param" }, argumentNumber),
                react_2.default.createElement("button", { "data-testid": "throttle-button", onClick: addNumberThrottled }, "Add number throttled"),
                react_2.default.createElement("button", { "data-testid": "throttle-button-with-param", onClick: addNumberThrottledWithParameter }, "Add number throttled")));
        };
    });
    ...
    it("should update value twice when clicked twice, with 300ms break between them", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    getByTestId = react_1.render(react_2.default.createElement(App, null)).getByTestId;
