...
describe("useDimensionsRef", function () {
    ...
    describe("base", function () {
        it("runs immediately after mount", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                expect.assertions(1);
                result = react_hooks_1.renderHook(function () { return useDimensionsRef_1.useDimensionsRef(); }).result;
    ...
    describe("usage", function () {
        ...
        beforeEach(function () {
            ...
            App = function () {
                var _a;
                var _b = __read(useDimensionsRef_1.useDimensionsRef(), 2), ref = _b[0], dimensions = _b[1];
                return (react_2.default.createElement("div", null,
                    react_2.default.createElement("span", { "data-testid": "value" }, (_a = dimensions === null || dimensions === void 0 ? void 0 : dimensions.width) !== null && _a !== void 0 ? _a : "null"),
                    react_2.default.createElement("span", { "data-testid": "element", ref: ref }, "Hello")));
            };
        });
