...
describe('useDocumentEventListener', function () {
    ...
    it('should return a undefined', function () {
        var result = react_hooks_1.renderHook(function () {
            return useDocumentEventListener_1.useDocumentEventListener('click', function () {
                console.log('clicked');
            });
        }).result;
...
describe('useDocumentEventListener jsx', function () {
    ...
    beforeEach(function () {
        ...
        TestJSX = function () {
            useDocumentEventListener_1.useDocumentEventListener('click', mockCallback);
            return null;
        };
    });
...
describe('useDocumentEventListener state variables', function () {
    ...
    beforeEach(function () {
        TestJSX = function () {
            ...
            useDocumentEventListener_1.useDocumentEventListener('click', increment);
