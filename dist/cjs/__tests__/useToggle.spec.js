...
describe('useToggle behaviour', function () {
    ...
    beforeEach(function () {
        App = function () {
            var _a = __read(useToggle_1.useToggle(true), 2), value = _a[0], toggleValue = _a[1];
            return (react_2.default.createElement("p", { "data-testid": "toggle-element", onClick: toggleValue }, value.toString()));
        };
    });
...
describe('useToggle with custom toggle function', function () {
    ...
    beforeEach(function () {
        App = function () {
            var _a = __read(useToggle_1.useToggle('regina', function (v) {
                return v === 'regina' ? 'phalange' : 'regina';
            }), 2), value = _a[0], toggleValue = _a[1];
            return (react_2.default.createElement("p", { "data-testid": "toggle-element", onClick: toggleValue }, value));
        };
    });
    afterEach(react_1.cleanup); // <-- add this
    it('should be defined', function () {
...
describe('useToggle with custom toggle function', function () {
    ...
    beforeEach(function () {
        App = function () {
            var _a = __read(useToggle_1.useToggle(), 2), value = _a[0], toggleValue = _a[1];
            return (react_2.default.createElement("p", { "data-testid": "toggle-element", onClick: toggleValue }, value.toString()));
        };
    });
    afterEach(react_1.cleanup); // <-- add this
...
describe('useToggle with reducer', function () {
    ...
    beforeEach(function () {
        ...
        App = function () {
            var _a = __read(useToggle_1.useToggle(1, toggleReducer), 2), value = _a[0], dispatch = _a[1];
            return (react_2.default.createElement(react_2.default.Fragment, null,
                react_2.default.createElement("p", { "data-testid": "toggle-element" }, value.toString()),
                react_2.default.createElement("button", { "data-testid": "yep-button", onClick: function () { return dispatch({ type: 'yep' }); } }),
                react_2.default.createElement("button", { "data-testid": "nope-button", onClick: function () { return dispatch({ type: 'nope' }); } }),
                react_2.default.createElement("button", { "data-testid": "maybe-button", onClick: function () { return dispatch({ type: 'maybe' }); } })));
        };
    });
    afterEach(react_1.cleanup); // <-- add this
