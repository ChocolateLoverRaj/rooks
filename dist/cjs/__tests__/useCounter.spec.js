...
describe("useCounter", function () {
    ...
    it("should initialize correctly", function () {
        var result = react_hooks_1.renderHook(function () { return useCounter_1.useCounter(0); }).result;
        expect(result.current.value).toBe(0);
    });
    it("should increment", function () {
        var _a = react_hooks_1.renderHook(function () { return useCounter_1.useCounter(0); }), result = _a.result, rerender = _a.rerender;
        act(function () {
    ...
    it("should incrementBy", function () {
        var _a = react_hooks_1.renderHook(function () { return useCounter_1.useCounter(5); }), result = _a.result, rerender = _a.rerender;
        act(function () {
