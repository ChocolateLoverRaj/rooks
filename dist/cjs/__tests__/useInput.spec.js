...
describe("useInput", function () {
    ...
    describe("basic", function () {
        ...
        beforeEach(function () {
            App = function () {
                var myInput = useInput_1.useInput("hello");
                return (react_2.default.createElement("div", null,
                    react_2.default.createElement("input", __assign({ "data-testid": "input-element" }, myInput)),
                    react_2.default.createElement("input", __assign({ "data-testid": "display-element" }, myInput))));
            };
        });
        afterEach(react_1.cleanup); // <-- add this
        test("memo", function () {
            var _a = react_hooks_1.renderHook(function () { return useInput_1.useInput("hello"); }), result = _a.result, rerender = _a.rerender;
    ...
    describe("validate", function () {
        ...
        beforeEach(function () {
            App = function (_a) {
                ...
                var myInput = useInput_1.useInput(5, {
                    validate: validate || (function (newValue) { return newValue < 10; }),
                });
                return (react_2.default.createElement("div", null,
                    react_2.default.createElement("input", __assign({ "data-testid": "input-element", type: "number" }, myInput))));
            };
        });
        afterEach(react_1.cleanup); // <-- add this
        ...
        it("validate can be used to compare possible newvalue with current value", function () {
            var getByTestId = react_1.render(react_2.default.createElement(App, { validate: function (newValue, currentValue) { return newValue % currentValue != 0; } })).getByTestId;
            var inputElement = getByTestId("input-element");
            react_1.act(function () {
                react_1.fireEvent.change(inputElement, {
                    target: {
    ...
    describe("multiple", function () {
        ...
        beforeEach(function () {
            App = function () {
                var myInput = useInput_1.useInput(5);
                var myInput2 = useInput_1.useInput(myInput.value);
                return (react_2.default.createElement("div", null,
                    react_2.default.createElement("input", __assign({ "data-testid": "input-element1", type: "number" }, myInput)),
                    react_2.default.createElement("input", __assign({ "data-testid": "input-element2", type: "number" }, myInput2))));
            };
        });
        afterEach(react_1.cleanup); // <-- add this
