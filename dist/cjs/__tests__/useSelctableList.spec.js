...
describe("useSelctableList", function () {
    ...
    var result = react_hooks_1.renderHook(function () { return useSelectableList_1.useSelectableList([1, 2, 3]); }).result;
    describe("matchSelection", function () {
        ...
        test("match index", function () {
            var internalResult = react_hooks_1.renderHook(function () {
                return useSelectableList_1.useSelectableList([1, 2, 3], 0, true);
            }).result;
    ...
    describe("toggleSelection", function () {
        ...
        test("shouldn't toggle selected index when allowUnselected = false", function () {
            var internalResult = react_hooks_1.renderHook(function () {
                return useSelectableList_1.useSelectableList([1, 2, 3], 0, false);
            }).result;
