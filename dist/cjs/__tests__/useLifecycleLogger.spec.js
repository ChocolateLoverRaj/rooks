...
describe("useLifecycleLogger", function () {
    ...
    it("should work without arguments", function () {
        var unmount = react_hooks_1.renderHook(function () { return useLifecycleLogger_1.useLifecycleLogger(); }).unmount;
    ...
    it("should log the provided args on mount", function () {
        var args = ["foo", "bar"];
        var unmount = react_hooks_1.renderHook(function () { return useLifecycleLogger_1.useLifecycleLogger("Test1", args); }).unmount;
        expect(logSpy).toHaveBeenCalledTimes(1);
    ...
    it("should log when the component has unmounted", function () {
        var args = ["foo", "bar"];
        var unmount = react_hooks_1.renderHook(function () { return useLifecycleLogger_1.useLifecycleLogger("Test2", args); }).unmount;
        unmount();
    ...
    it("should log updates as args change", function () {
        var _a = react_hooks_1.renderHook(function (_a) {
            ...
            return useLifecycleLogger_1.useLifecycleLogger(componentName, args);
        }, {
