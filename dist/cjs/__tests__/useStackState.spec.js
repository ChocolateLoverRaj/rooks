...
describe("useStackState", function () {
    ...
    it("should initialize correctly", function () {
        var result = react_hooks_1.renderHook(function () { return useStackState_1.useStackState([1, 2, 3]); }).result;
    ...
    it("should push correctly", function () {
        var _a = react_hooks_1.renderHook(function () { return useStackState_1.useStackState([1, 2, 3]); }), result = _a.result, rerender = _a.rerender;
        // memo
        rerender();
    ...
    it("handles empty arrays", function () {
        var result = react_hooks_1.renderHook(function () { return useStackState_1.useStackState([]); }).result;
        act(function () {
            result.current[1].pop();
        });
        act(function () {
