...
describe("useMapState", function () {
    describe("with object", function () {
        ...
        it("should initialize correctly", function () {
            var result = renderHook(function () { return useMapState({ a: 1 }); }).result;
            expect(result.current[0]).toEqual({ a: 1 });
        });
        it("should set a new value correctly", function () {
            var _a = renderHook(function () { return useMapState({ a: 1 }); }), result = _a.result, rerender = _a.rerender;
            // test memo
        ...
        it("should work when value to remove does not exist", function () {
            var result = renderHook(function () { return useMapState({ a: 1, b: 2, c: 3 }); }).result;
            act(function () {
        ...
        it("should remove multiple existing values correctly", function () {
            var _a = renderHook(function () {
                return useMapState({ a: 1, b: 3, c: 5 });
            }), result = _a.result, rerender = _a.rerender;
            // test memo
        ...
        it("should removeAll values", function () {
            var _a = renderHook(function () {
                return useMapState({ a: 1, b: 2, c: 3 });
            }), result = _a.result, rerender = _a.rerender;
            // test memo
    ...
    describe("with map", function () {
        ...
        it("should initialize correctly", function () {
            var result = renderHook(function () { return useMapState(new Map([["a", 1]])); }).result;
            expect(__spreadArray([], __read(result.current))).toEqual([["a", 1]]);
        });
        it("should set a new value correctly", function () {
            var _a = renderHook(function () {
                return useMapState(new Map([["a", 1]]));
            }), result = _a.result, rerender = _a.rerender;
            // test memo
