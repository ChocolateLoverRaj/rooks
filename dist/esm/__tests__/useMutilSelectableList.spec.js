...
describe("useMultiSelectableList", function () {
    ...
    var result = renderHook(function () { return useMultiSelectableList([1, 2, 3]); }).result;
    describe("matchSelection", function () {
        ...
        test("match index", function () {
            var internalResult = renderHook(function () {
                return useMultiSelectableList([1, 2, 3], [0, 1], true);
            }).result;
    ...
    describe("updateSelections", function () {
        test("set by index", function () {
            var internalResult = renderHook(function () {
                return useMultiSelectableList([1, 2, 3], [0], true);
            }).result;
            act(function () {
    ...
    describe("toggleSelection", function () {
        ...
        test("shouldn't toggle selected index when allowUnselected = false", function () {
            var internalResult = renderHook(function () {
                return useMultiSelectableList([1, 2, 3], [0], false);
            }).result;
